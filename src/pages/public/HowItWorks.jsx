          ...
          {steps.map((step, i) => (
            <div key={step.title} className="relative flex gap-8">
              <div className="hidden md:flex flex-col items-center">
                <div className="w-14 h-14 rounded-full bg-neon-tangerine flex items-center justify-center text-white font-bold text-xl shrink-0">
                  {i + 1}
                </div>
                {i < steps.length - 1 && <div className="w-0.5 h-full bg-neon-tangerine/30 mt-2" />}
              </div>
              <div className="flex-1 pb-8">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 bg-neon-tangerine/10 rounded-xl flex items-center justify-center md:hidden">
                    <step.icon className="text-neon-tangerine" size={24} />
                  </div>
                  <step.icon className="hidden md:block text-neon-tangerine" size={24} />
      ...
      <section className="py-20 bg-dark-lavender">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link to={ROUTES.REGISTER}>
            <Button size="lg" className="bg-white text-dark-lavender hover:bg-gray-100">
