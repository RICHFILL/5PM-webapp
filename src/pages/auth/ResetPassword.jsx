...
function ResetPassword() {
  ...
  const passwordInputClass = `w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-neon-tangerine focus:border-transparent outline-none transition-colors ${password ? (allChecksMet ? "border-green-500" : "border-red-300") : "border-gray-300"}`;
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <div className="relative">
            <input type={showPassword ? "text" : "password"} value={password}
              onChange={(e) => setPassword(e.target.value)} placeholder="Create a strong password" required className={passwordInputClass} />
        ...
        <button type="submit" disabled={loading || !allChecksMet || !passwordsMatch}
