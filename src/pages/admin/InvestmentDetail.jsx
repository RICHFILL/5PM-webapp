...
export default function InvestmentDetail() {
  ...
  const metrics = [
    ...
    { label: "Interest Earned in 12months", value: formatCurrency(inv.interestEarned), icon: TrendingUp, color: "text-violet-600", bg: "bg-violet-50" },
    { label: "Monthly payment", value: formatCurrency(inv.expectedMonthlyRepayment), icon: Banknote, color: "text-amber-600", bg: "bg-amber-50" },
